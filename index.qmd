...
[Browse the GitHub repository](https://github.com/ann1ejohansson/bds-toolbox-2025){target="_blank"}
...
Submit **both** assignments to canvas. Assignment 2 should also be submitted to this site, via a GitHub pull request. Instructions for this can be found [on the GitHub landing page](https://github.com/ann1ejohansson/bds-toolbox-2025). ---
