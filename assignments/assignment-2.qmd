...
```{r setup running locally, eval = TRUE, include=FALSE}
# set up when testing the file locally, set eval = FALSE when running on server
...
-   Start by working with a **subset** of the data, to get a good idea of the data structure and variables, without running heavy computations. This should make your workflow more efficient.
...
-   Add interactive elements **if you think it adds value to your visualization**.
...
# Need motivation logs, domains, and user tables. Also merge these already? 
```
